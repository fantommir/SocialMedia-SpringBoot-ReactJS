...
// import ScrollUseEffect from "../Hooks/ScrollUseEffect";
// import { NotificationPostModal } from "./NotificationPostModal";
// // import { fetchNotifications } from "../api/ApiCalls";
// const NotificationModal = React.memo(() => {
//   const allNotifications = useSelector((store) => store.notification.data);
...
//     // fetchNotifications({ page }).then((res) =>
//     //   setAllNotifications([...allNotifications, ...res])
//     // );
//   }, [page]);
//   return (
//     <>
